...
<body>    
    <div id="login-container">
        <div id="imgage">
            ...
            <div id="login">
                <h3>Xin chào bạn</h3>
                <h2 style="cursor:inherit">Đăng nhập để tiếp tục</h2>
        <form action="LoginServlet" method="POST">
            ...
            <div class="form-group">
                ...
                <p style="margin-left: 180px;"><a href="forgot_password.jsp"> Quên mật khẩu? </a></p>
            </div>
            
            <p style="color: black; cursor: inherit">Chưa là thành viên? <a href="register.jsp"><i>Đăng ký</i></a> tại đây</p>
        </form>
        </div>
    </div>
</body>
